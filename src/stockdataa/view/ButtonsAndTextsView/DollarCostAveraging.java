...
public class DollarCostAveraging extends JFrame implements Texts {
  ...
  public DollarCostAveraging(String tag) {
    super(tag);
    daysInvest = new JLabel("Enter the number of days of Investment");
    ...
    propMap = new JLabel("(Ticker, Proportion)");
    propMapF = new JTextField(20);
    commFee = new JLabel("Enter the commission Fee");
    commFeeF = new JTextField(20);
    amount = new JLabel("Enter the investment amount");
