...
public class TextGUI implements TextInterface {
  ...
  /**
   * This is to show portfolio type.
   */
  ...
  /**
   * This to show the smart portfolio.
   * @param add to add stocks.
   * @param disp to display.
   * @param perf to show performance.
   * @param cb cost basis.
   * @param sell sell stocks.
   */
