...
/**
 * This represents the class of Smart CController used for the SMart Portfolio.
 */
public class SmartController extends AbstractController {

  /**
   * This is the Smart controller for the Smart portfolio.
   *
   * @param model is the object of the Smart Portfolio.
   * @param in    is the input stream.
   * @param view  is the object of buttons.
   */
   ...
   * @param model is the object of the Smart Portfolio.
   * @param in    is the input stream.
   * @param view  is the object of Textnterface.
   */
  ...
  /**
   * This is the Smart controller with Operations model and Buttons view.
   *
   * @param m is model object.
  ...
  /**
   * This is the main controller handling all th interfaces.
   *
