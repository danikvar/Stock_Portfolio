...
import stockdataa.view.buttons.BuyMain;
import stockdataa.view.buttons.CheckCost;
import stockdataa.view.buttons.CheckValue;
import stockdataa.view.buttons.DisplayAllPorts;
import stockdataa.view.buttons.Home;
import stockdataa.view.buttonsandtexts.BuyStock;
import stockdataa.view.buttonsandtexts.CheckCB;
import stockdataa.view.buttonsandtexts.CheckCBD;
import stockdataa.view.buttonsandtexts.CheckVal;
import stockdataa.view.buttonsandtexts.CheckValByD;
import stockdataa.view.buttonsandtexts.CreateUser;
import stockdataa.view.buttonsandtexts.DollarCostAveraging;
import stockdataa.view.buttonsandtexts.PortPerformance;
import stockdataa.view.buttonsandtexts.PortfolioPerformance;
import stockdataa.view.buttonsandtexts.Reading;
import stockdataa.view.buttonsandtexts.Saving;
import stockdataa.view.buttonsandtexts.SellStock;
import stockdataa.view.buttonsandtexts.ShowAllUsers;
import stockdataa.view.buttonsandtexts.Texts;
...
public class GUIController extends SmartController implements ActionListener {
  ...
  private Map<String, Runnable> buttonAssign() {
    ...
    buttonMap.put("inv proceed", () -> {
      ...
      if (!sdate.matches("^\\d{4}-\\d{2}-\\d{2}$") || sdate.equals("")) {
